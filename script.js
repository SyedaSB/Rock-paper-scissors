...
function play(clicked_id) {
    ...
    if (noofmatch == 5) {
        ...
        if(compscore==userscore){
            document.getElementById("text").innerHTML="It's a Draw🤝 but what an Awesome match!!"
        }
        else if(compscore>userscore){
            document.getElementById("text").innerHTML="Computer won this match 🤖. Call for a next match.. "
        }
        else if(compscore<userscore){
